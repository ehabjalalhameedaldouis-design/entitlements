...
class AppWords {
  static Map<String, Map<String, String>> words = {
    'en': {
      ...
      'google_managed_password':
          'Your password is managed by Google. Please change it from your Google account.',
      'google_managed_email':
          'Your email is managed by Google. Please change it from your Google account.',
    ...
    'ar': {
      ...
      'please_agree_to_policy': 'يرجى الموافقة على سياسة الخصوصية للمتابعة.',
      'my_account': 'حسابي',
      'login_method': 'طريقة تسجيل الدخول',
      'account_created_at': 'عضو منذ',
      'change_password': 'تغيير كلمة المرور',
      'change_email': 'تغيير البريد الإلكتروني',
      'delete_account': 'حذف الحساب',
      'confirm_delete_account':
          'هل أنت متأكد من حذف حسابك وجميع بياناتك نهائياً؟',
      'password_updated': 'تم تحديث كلمة المرور بنجاح.',
      'email_verification_sent': 'تم إرسال رسالة تحقق إلى بريدك الجديد.',
      'google_managed_password':
          'كلمة المرور تُدار عبر حساب Google، يرجى تغييرها من حساب Google.',
      'google_managed_email':
          'البريد الإلكتروني يُدار عبر حساب Google، يرجى تغييره من حساب Google.',
